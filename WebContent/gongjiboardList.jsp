...
%>
      ...
      <table align=center border=0 width=80%>
         <tr>
            ...
            <td align=right>
               <form  action="admin" name="gongjiPost" method="post">
   ...
   for(int i=beginPerPage; i< beginPerPage + numPerPage; i++){
        ...
        %>
                  ...
                  <tr>
                     ...
                     <form action="admin" method="post" name="gongjiRead">
                        <td align="center"><a
                           href="admin?cmd=GONGJIBOARDREAD&gongji_no=<%=dto.getGongji_no()%>">
      ...
      <form action="admin" name="gongjisearch" method="post">   
